 ...
 * @returns
 */
function o(t,e,r,n,i){this.empty(),this.cls=t,r&&"object"==typeof r&&this.loadClassFrames(r),e&&"object"==typeof e?(this.originalFrames=e,this.loadDataFrames(e)):this.originalFrames=!1,this.parent=n,this.parentframe=i,this.newDoc=!1}function s(t,e,r){this.predicate=t,this.cframe=e,this.parent=r,this.values=[]}function a(t,e,r){this.err=!1,this.parent=e,this.subjid=!!e&&e.subjid,this.index=r,t&&this.load(t)}function u(t,e){this.err=!1,this.parent=e,this.subjid=!!e&&e.subjid,t&&this.load(t)}function c(t){this.min=0,this.max=0,t&&this.loadRestriction(t)}o.prototype.loadClassFrames=function(t){for(let e=0;e<t.length;e+=1){t[e]["@context"]&&(this.jsonld_context=t[e]["@context"]);const r=new u(t[e]);if(r.isValid()&&(this.classframes||(this.classframes={}),void 0===this.classframes[t[e].property]&&(this.classframes[t[e].property]=[]),this.classframes[t[e].property]=r,r.isObject()&&this.properties[t[e].property]))for(let r=0;r<this.properties[t[e].property].values.length;r+=1)this.properties[t[e].property].values[r].loadClassFrames(t[e].frame)}return this},o.prototype.hasSchema=function(){return!n.empty(this.classframes)},o.prototype.loadDataFrames=function(t){if("object"==typeof t&&t.length){this.originalFrames||(this.originalFrames=t),!this.subjid&&t[0].domainValue&&(this.subjid=t[0].domainValue);for(let e=0;e<t.length;e+=1){t[e]["@context"]&&(this.jsonld_context=t[e]["@context"]);let r=this.getPropertyClassFrame(t[e].property,t[e]);r&&r.isClassChoice()?(r=r.getChosenClassFrame(t[e].range),r||console.log(`no choice frame ${t[e].range}`)):r&&r.isLogic()&&(r=r.getChosenFrame(t[e])),r&&(void 0===this.properties[t[e].property]&&(this.properties[t[e].property]=new s(t[e].property,r,this)),this.properties[t[e].property].addFrame(t[e]))}return this}},o.prototype.getAsFrame=function(t,e){if(this.parentframe)return this.parentframe;const r={type:"objectProperty",property:t};r.range=this.cls,r.domain=e.cls,r.domainValue=e.subjid,r.frame=[];for(const t of Object.keys(this.properties))r.frame=r.frame.concat(r.frame,this.properties[t].getAsFrames());return r},o.prototype.getAsFrames=function(t,e){var r=[];for(const t of Object.keys(this.properties))r=r.concat(r,this.properties[t].getAsFrames());return r},o.prototype.empty=function(){this.properties={},this.restrictions={},this.subjid=!1,this.cls=!1},o.prototype.reset=function(t){if(t){const e=[];for(let r=0;r<this.originalFrames.length;r+=1)this.originalFrames[r].property===t&&e.push(this.originalFrames[r]);this.properties[t]&&(this.properties[t]=[]),this.loadDataFrames(e)}else this.restrictions={},this.properties={},this.loadDataFrames(this.originalFrames)},o.prototype.clear=function(){for(const t of Object.keys(this.properties))this.properties[t].clear();return this},o.prototype.filter=function(t,e){(new i).testRules(t,this,e);for(const r of Object.keys(this.properties))this.properties[r].filter(t,e);return this},o.prototype.getPropertyClassFrame=function(t,e){if(this.classframes&&"object"==typeof this.classframes&&"object"==typeof this.classframes[t])return this.classframes[t];if(e){return new u(e)}return!!this.properties[t]&&new u(this.properties[t].values[0])},o.prototype.getProperties=function(t){if("filled"==t||!this.classframes)return Object.keys(this.properties);if("missing"==t){const t=Object.keys(this.properties),e=Object.keys(this.classframes),r=[];for(let n=0;n<e.length;n++)-1==t.indexOf(e[n])&&-1==r.indexOf(e[n])&&r.push(e[n]);return r}return Object.keys(this.classframes)},o.prototype.getMissingPropertyList=function(){var t=this.getProperties("missing");const e=[];for(let n=0;n<t.length;n++){const i=this.getPropertyClassFrame(t[n]);if(i)var r={label:i.getLabel(),value:t[n]};else r={label:t[n],value:t[n]};e.push(r)}return e},o.prototype.getFilledPropertyList=function(){var t=this.getProperties("filled");const e=[];for(let n=0;n<t.length;n++){const i=this.getPropertyClassFrame(t[n]);if(i)var r={label:i.getLabel(),value:t[n]};else r={label:t[n],value:t[n]};e.push(r)}return e},o.prototype.fillFromSchema=function(t){t&&(this.subjid=t),t=t||n.genBNID();const e={};if(this.classframes)for(const r of Object.keys(this.classframes)){const n=this.getPropertyClassFrame(r);e[r]=new s(r,n,this),e[r].fillFromSchema(t)}this.properties=e,this.originalFrames=[];for(const t of Object.keys(this.properties))this.originalFrames.push(this.properties[t].getAsFrames());return this},o.prototype.clone=function(t){const e={},r=new o(this.cls,!1,!1,this.parent);r.classframes=this.classframes,r.subjid=t;for(const t of Object.keys(this.properties))e[t]=this.properties[t].clone();return r.properties=e,r},o.prototype.getChild=function(t,e){let r=this.getProperty(e);for(let e=0;e<r.values.length;r++)if(r.values[e].isObject()&&r.values[e].subject===t)return r.values[e];if(!e)for(const e of Object.keys(this.properties))for(let r=0;r<this.properties[e].values.length;r+=1)if(this.properties[e].values[r].subject()===t)return this.properties[e].values[r];return!1},o.prototype.addProperty=function(t,e){const r=this.getPropertyClassFrame(t);var i=!1;if(r){const o=new s(t,r,this);if(r.isObject()){r.isClassChoice()||(i=r.createEmpty(n.genBNID())),e&&(i=r.createEmptyChoice(e,n.genBNID()));const t=r.getClassChoices();t&&t.length&&(i=r.createEmptyChoice(t[0],n.genBNID()))}else i=r.createEmpty();return i&&o.addValueFrame(i),void 0===this.properties[t]&&(this.properties[t]=[]),this.properties[t].push(o),o}return!1},o.prototype.addPropertyValue=function(t,e){return this.properties[t].addValue(e)},o.prototype.removeProperty=function(t){void 0!==this.properties[t]&&delete this.properties[t]},o.prototype.removePropertyValue=function(t,e,r){const n=this.properties[t];n.removeValue(e,r),0==n.values.length&&this.removeProperty(t)},o.prototype.error=function(t){console.error(t)},o.prototype.extract=function(){var t={};for(var e in this.properties)for(var r=0;r<this.properties[e].length;r++){var i=this.properties[e][r].extract();n.empty(i)||(void 0===t[e]&&(t[e]=[]),t[e]=t[e].concat(i))}return(!n.empty(t)||!this.parent)&&this.extractJSONLD(t)},o.prototype.extractJSONLD=function(t){return t["@type"]=this.cls,"_:"!=this.subject()&&(t["@id"]=this.subject()),this.jsonld_context&&(t["@context"]=this.jsonld_context),t},o.prototype.subject=function(){return this.subjid},o.prototype.get=o.prototype.subject,o.prototype.set=function(t){this.subjid=t},o.prototype.isObject=function(){return!0},o.prototype.isProperty=function(){return!1},o.prototype.isData=function(){return!1},o.prototype.subjectClass=function(){return this.cls},o.prototype.depth=function(){return this.parent?this.parent.depth()+1:0},o.prototype.getProperty=function(t){return this.properties[t]},o.prototype.first=function(t){if(this.properties&&this.properties[t])return this.properties[t].first()},o.prototype.property=function(t){return!!this.parent&&this.parent.property()},o.prototype.parentObject=function(){return!(!this.parent||!this.parent.parent)&&this.parent.parent},o.prototype.root=function(){return!this.parent},o.prototype.renderProperties=function(){const t=this.sortProperties(),e=[];for(let r=0;r<t.length;r++)if(this.properties[t[r]].render){const n=this.properties[t[r]].render(this.properties[t[r]]);n&&e.push(n)}return e},o.prototype.sortProperties=function(){const t=Object.keys(this.properties);return this.compare?t.sort((t,e)=>this.compare(t,e,this)):t.sort((t,e)=>this.standardCompare(t,e,this))},o.prototype.standardCompare=function(t,e,r){return"rdfs:label"==t?-1:"rdfs:label"==e?1:"rdfs:comment"==t?-1:"rdfs:comment"==e?1:r.properties[t].isData()&&r.properties[e].isObject()?-1:r.properties[e].isData()&&r.properties[t].isObject()?1:0},o.prototype.cardControlAllows=function(t){if(!this.parent)return!0;if(this.parent.cframe.hasRestriction()){var e=this.parent.cframe.restriction,r=this.parent.values.length;if(("add"==t||"clone"==t)&&e.max&&r>=e.max)return!1;if("delete"==t&&e.min&&r<=e.min)return!1}return!0},o.prototype.isUpdated=function(){var t=0;for(var e in this.properties){if(this.originalFrames[t]!=e)return!0;if(this.properties[e].isUpdated())return!0;t++}return t!=this.originalFrames.length},o.prototype.isNew=function(){return"_:"==this.subject().substring(0,2)},o.prototype.getSummary=function(){var t={status:"ok"};for(var e in this.isUpdated()&&(t.status="updated"),this.isNew()&&(t.status="new"),t.propcount=0,this.properties)t.propcount++;return t.long=t.propcount+" properties",t},s.prototype.addFrame=function(t){if(this.cframe.isData()){var e=new a(t,this,this.values.length);this.values.push(e)}else{const e=new o(this.range(),this.cframe.frame,t.frame,this,t);this.values.push(e)}},s.prototype.addValueFrame=function(t){t.parent=this,t.index=this.values.length,this.values.push(t)},s.prototype.fillFromSchema=function(t){if(this.isData()||this.isObject()&&!this.isClassChoice()){var e=[];if(this.cframe.hasRestriction()&&this.cframe.restriction.min)for(let n=0;n<this.cframe.restriction.min;n+=1){var r;(r=this.createEmpty(t)).parent=this,e.push(r)}else(r=this.createEmpty(t)).parent=this,e.push(r);this.values=e}else if(this.isClassChoice()){const t=this.cframe.getClassChoices();if(t&&t.length){const e=this.cframe.createEmptyChoice(t[0],n.genBNID());e.parent=this,this.values=[e]}}},s.prototype.isData=function(){return this.cframe.isData()},s.prototype.isObject=function(){return this.cframe.isObject()},s.prototype.isProperty=function(){return!0},s.prototype.property=function(){return this.predicate},s.prototype.extract=function(){const t=[];for(let e=0;e<this.values.length;e++){const r=this.values[e].extract();""!==r&&!1!==r&&void 0!==r&&t.push(r)}return t},s.prototype.subject=function(){return!!this.parent&&this.parent.subject()},s.prototype.subjectClass=function(){return!!this.parent&&this.parent.subjectClass()},s.prototype.depth=function(){return!!this.parent&&this.parent.depth()},s.prototype.updated=function(){return!!this.parent&&this.parent.childUpdated()},s.prototype.range=function(){return this.cframe?this.cframe.range:""},s.prototype.getLabel=function(){return this.cframe?this.cframe.getLabel():""},s.prototype.getComment=function(){return!!this.cframe&&this.cframe.getComment()},s.prototype.hasCardinalityRestriction=function(){return!!this.cframe&&this.cframe.hasRestriction()},s.prototype.getRestriction=function(){return!!this.cframe&&this.cframe.restriction},s.prototype.isClassChoice=function(){return!!this.cframe&&this.cframe.isClassChoice()},s.prototype.deletePropertyValue=function(t,e){this.parent.removePropertyValue(this.property(),t,e)},s.prototype.get=function(){for(var t=[],e=0;e<this.values.length;e++)if(this.values[e]){var r=this.values[e].get();r&&t.push(r)}return t},s.prototype.set=function(t){for(var e=0;e<this.values.length;e++)this.values[e]&&this.values[e].set(t)},s.prototype.clear=function(){for(var t=0;t<this.values.length;t++)this.values[t].clear()},s.prototype.clone=function(){const t=[],e=new s(this.predicate,this.cframe,this.parent);for(var r=0;r<this.values.length;r++)t.push(this.values[r].clone());return e.values=t,e},s.prototype.getAsFrames=function(){for(var t=[],e=0;e<this.values.length;e++)this.values[e]&&(this.isData()?t.push(this.values[e].getAsFrame()):t=t.concat(this.values[e].getAsFrames()));return t},s.prototype.createEmpty=function(){if(this.cframe.isData()){const t=this.cframe.copy();return t.set(""),t}if(this.cframe.isObject()){if(!this.cframe.isClassChoice()){return this.cframe.createEmpty(n.genBNID())}const t=this.cframe.getClassChoices();if(t&&t.length){return this.cframe.createEmptyChoice(t[0],n.genBNID())}}},s.prototype.filter=function(t,e){(new i).testRules(t,this,e);for(var r=0;r<this.values.length;r++)this.values[r].filter(t,e);return this},s.prototype.first=function(){if(this.values&&this.values[0])return this.values[0].get()},s.prototype.renderValues=function(){for(var t=this.sortValues(),e=[],r=0;r<t.length;r++)if(t[r]&&t[r].render){var n=t[r].render(t[r]);n&&e.push(n)}return e},s.prototype.sortValues=function(){return this.compare?this.values.sort((t,e)=>this.compare(t,e,this)):this.values},s.prototype.cardControlAllows=function(t){if(this.cframe.hasRestriction()){var e=this.cframe.restriction,r=this.values.length;if(("add"==t||"clone"==t)&&e.max&&r>=e.max)return!1;if("delete"==t&&e.min)return!1}return!0},s.prototype.isUpdated=function(){return!0},a.prototype.load=function(t){if("object"!=typeof t)return void this.error("No frame passed to load");this.type=t.type,this.predicate=t.property,this.range=t.range,this.rangeValue=t.rangeValue,this.domain=t.domain,this.domainValue=t.domainValue,this.frame=t.frame,this.label=t.label,this.comment=t.comment;const{restriction:e}=t;this.restriction=!1,e&&"object"==typeof e&&(this.restriction=new c(e))},a.prototype.filter=function(t,e){(new i).testRules(t,this,e);return this},a.prototype.delete=function(){this.parent.deletePropertyValue(this.get(),this.index)},a.prototype.save=function(){this.parent&&this.parent.save()},a.prototype.reset=function(){this.set(this.originalValue)},a.prototype.clone=function(){const t=this.parent.addPropertyValue(this.get()),e=this.copy(t);e.setNew(),e.mode="edit",e.index=this.parent.values.length,this.parent.values.push(e)},a.prototype.depth=function(){return!!this.parent&&this.parent.depth()},a.prototype.property=function(){return!!this.parent&&this.parent.property()},a.prototype.subject=function(){return!!this.parent&&this.parent.subject()},a.prototype.subjectClass=function(){return!!this.parent&&this.parent.subjectClass()},a.prototype.type=function(){return!!this.range&&this.range},a.prototype.isValidType=function(t){return-1!==["datatypeProperty","objectProperty","restriction "].indexOf(t)},a.prototype.getAsFrame=function(){const t={type:this.type,property:this.property()};return this.range&&(t.range=this.range),this.rangeValue&&(t.rangeValue=this.rangeValue),this.domain&&(t.domain=this.domain),this.domainValue&&(t.domainValue=this.domainValue),this.frame&&(t.frame=this.frame),this.label&&(t.label=this.label),this.comment&&(t.comment=this.comment),t},a.prototype.hasRestriction=function(){return!!this.restriction&&this.restriction.hasCardRestriction()},a.prototype.copy=function(t){const e=new a(this,this.parent);return t&&(e.domainValue=t),e},a.prototype.getLabel=function(){let t="";return"rdfs:label"==this.predicate?"Name":"rdfs:comment"==this.predicate?"Description":(this.label&&"object"==typeof this.label&&(t=this.label["@value"]),this.label&&"string"==typeof this.label&&(t=this.label),!t&&this.property()&&(t=n.labelFromURL(this.property())),t||(t=n.labelFromURL(this.cls)),t)},a.prototype.getType=function(){return this.range?this.range:!(!this.rangeValue||!this.rangeValue.type)&&this.rangeValue.type},o.prototype.getLabel=a.prototype.getLabel,a.prototype.getComment=function(){let t="";return this.comment&&"object"==typeof this.comment&&(t=this.comment["@value"]),this.comment&&"string"==typeof this.comment&&(t=this.comment),t},o.prototype.getComment=a.prototype.getComment,a.prototype.error=function(t){return t&&(this.err=t),this.err},a.prototype.isValid=function(){return this.type&&this.isValidType(this.type)?this.predicate?this.domain?this.range?!(this.isObjectProperty()&&(!this.frame||"object"!=typeof this.frame))||(this.error("Missing Object Frame"),!1):(this.error("Missing Frame Range"),!1):(this.error("Missing Frame Domain"),!1):(this.error("Missing Frame Property"),!1):(this.error(`Missing or Illegal Frame Type ${this.type}`),!1)},a.prototype.isObjectProperty=function(){return"objectProperty"===this.type},a.prototype.isDatatypeProperty=function(){return"datatypeProperty"===this.type},a.prototype.isLogic=function(){return"and"===this.type||"or"===this.type||"xor"===this.type},a.prototype.isRestriction=function(){return"restriction"===this.type},a.prototype.ftype=function(){return this.isDocument()?"document":this.isDatatypeProperty()?"data":this.isChoice()?"oneOf":this.isObject()?"object":this.isLogic()?"logic":this.isClassChoice()?"class_choice":void 0},a.prototype.isClassChoice=function(){return this.frame&&"class_choice"===this.frame.type},a.prototype.isString=function(){return this.range===n.getStdURL("xsd","string")},a.prototype.getChoiceOptions=function(){const t=[];for(let e=0;e<this.frame.elements.length;e+=1){const r={};this.frame.elements[e].label?r.label=this.frame.elements[e].label["@value"]:r.label=n.labelFromURL(this.frame.elements[e].class),r.value=this.frame.elements[e].class,t.push(r)}return t},a.prototype.lang=function(){return"en"},a.prototype.isChoice=function(){return this.frame&&"oneOf"===this.frame.type},a.prototype.isDocument=function(){return this.frame&&"document"===this.frame.type},a.prototype.isData=function(){return this.isDocument()||this.isChoice()||this.isDatatypeProperty()},a.prototype.isObject=function(){return this.isObjectProperty()&&this.frame&&!(this.isChoice()||this.isDocument())},a.prototype.isProperty=function(){return!1},a.prototype.getTypeShorthand=function(){if(this.isDocument())return"document";if(this.isChoice())return"choice";return n.getShorthand(this.getType())||this.getType()},a.prototype.get=function(){return this.contents?this.contents:this.isDatatypeProperty()&&this.rangeValue&&void 0!==this.rangeValue["@value"]?this.rangeValue["@value"]:this.isChoice()||this.isDocument()?this.frame.domainValue:""},a.prototype.set=function(t,e){e&&(t=e(t,this)),this.contents=t,(this.isChoice()||this.isDocument())&&(this.frame.domainValue=t),this.isDatatypeProperty()&&this.rangeValue&&(this.rangeValue["@value"]=t)},a.prototype.clear=function(){(this.isDocument()||this.isChoice()||this.isDatatypeProperty())&&this.set("")},a.prototype.cardControlAllows=function(t){if(this.parent.cframe.hasRestriction()){var e=this.parent.cframe.restriction,r=this.parent.values.length;if(("add"==t||"clone"==t)&&e.max&&r>=e.max)return!1;if("delete"==t&&e.min&&r<=e.min)return!1}return!0},a.prototype.extract=function(){var t=this.get();if(""!==t&&!1!==t){if(this.isDatatypeProperty()){var e={"@value":this.get()};return this.isString()?e["@language"]=this.lang():e["@type"]=this.getType(),e}if(this.isChoice()||this.isDocument())return{"@id":t}}return t},u.prototype=a.prototype,u.prototype.loadFromObjectFrame=function(t,e){this.type="objectProperty",this.predicate=t.property,this.range=t.range,this.rangeValue=e.subjid,this.domain=t.cls,this.domainValue=t.subjid,this.label=t.getLabel(),this.comment=t.getComment(),this.restriction=t.restriction},u.prototype.createEmptyChoice=function(t,e){const r=this.getChosenClassFrames(t),n=new o(t);return e&&(n.subjid=e),n.loadClassFrames(r),n.fillFromSchema()},u.prototype.getChosenClassFrames=function(t){let e=[];for(let r=0;r<this.frame.operands.length;r+=1)for(let n=0;n<this.frame.operands[r].length;n+=1)t===this.frame.operands[r][n].domain&&(e=e.concat(this.frame.operands[r][n]));return e},u.prototype.createEmpty=function(t){if(this.isObject()){const e=new o(this.range);return t&&(e.subjid=t),e.loadClassFrames(this.frame),e.fillFromSchema()}if(this.isData()){const t=this.copy();return t.set(""),t}},u.prototype.cloneDataFrame=function(t,e){return e},u.prototype.clone=function(t,e){if(this.isObject())console.log("cannot clone class frame");else if(this.isData())return this.cloneDataFrame(t,e)},u.prototype.getClassChoices=function(){const t=[];if(this.frame.operands)for(let e=0;e<this.frame.operands.length;e+=1)for(let r=0;r<this.frame.operands[e].length;r+=1){const n=this.frame.operands[e][r].domain;n&&-1===t.indexOf(n)&&t.push(n)}return t},u.prototype.getChosenClassFrame=function(t){for(let e=0;e<this.frame.operands.length;e+=1){const r=this.frame.operands[e];if(r.length){for(let e=0;e<r.length;e+=1)if(r[e]&&t===r[e].domain){return new u(r)}}else if(r.range&&t===r.range){return new u(r)}}return!1},u.prototype.getChosenFrame=function(t){return t},c.prototype.hasCardRestriction=function(){return 0!==this.min||0!==this.max},c.prototype.loadRestriction=function(t){if(void 0!==t.cardinality)this.max=t.cardinality,this.min=t.cardinality;else if(void 0!==t.maxCardinality)this.max=t.maxCardinality;else if(void 0!==t.minCardinality)this.min=t.minCardinality;else if(void 0!==t.type&&"and"===t.type&&"object"==typeof t.operands)for(let e=0;e<t.operands.length;e+=1){const r=new c(t.operands[e]);0===this.max&&r.max>0?this.max=r.max:this.max>0&&r.max>0&&r.max<this.max&&(this.max=r.max),0===this.min&&r.min>0?this.min=r.min:this.min>0&&r.min>0&&r.min>this.min&&(this.min=r.min)}},t.exports=o},function(t,e,r){"use strict";r.r(e);var n=r(0),i=r.n(n);function o(){return(o=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t}).apply(this,arguments)}function s(t,e){if(null==t)return{};var r,n,i={},o=Object.keys(t);for(n=0;n<o.length;n++)r=o[n],e.indexOf(r)>=0||(i[r]=t[r]);return i}var a={init:"init"},u={Cell:function(t){var e=t.cell.value;return void 0===e?"":e},width:150,minWidth:0,maxWidth:Number.MAX_SAFE_INTEGER};function c(t,e,r){return[].concat(t).sort((function(t,n){for(var i=0;i<e.length;i+=1){var o=e[i],s=!1===r[i]||"desc"===r[i],a=o(t,n);if(0!==a)return s?-a:a}return r[0]?t.index-n.index:n.index-t.index}))}function l(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r];return e.reduce((function(t,e){var r=e.style,n=e.className;return t=o({},t,{},s(e,["style","className"])),r&&(t.style=t.style?o({},t.style||{},{},r||{}):r),n&&(t.className=t.className?t.className+" "+n:n),""===t.className&&delete t.className,t}),{})}var p=function(t,e){return void 0===e&&(e={}),function(r){return void 0===r&&(r={}),[].concat(t,[r]).reduce((function(t,n){return function t(e,r,n){return"function"==typeof r?t({},r(e,n)):Array.isArray(r)?l.apply(void 0,[e].concat(r)):l(e,r)}(t,n,o({},e,{userProps:r}))}),{})}},h=function(t,e,r){return void 0===r&&(r={}),t.reduce((function(t,e){return e(t,r)}),e)},d=function(t,e){return void 0===e&&(e={}),t.forEach((function(t){t(e)}))};function f(t,e,r,n){t.findIndex((function(t){return t.pluginName===r}));e.forEach((function(e){t.findIndex((function(t){return t.pluginName===e}))})),n.forEach((function(e){t.findIndex((function(t){return t.pluginName===e}))}))}function y(t,e){return"function"==typeof t?t(e):t}function g(t){var e=i.a.useRef();return e.current=t,i.a.useCallback((function(){return e.current}),[])}var m="undefined"!=typeof document?i.a.useLayoutEffect:i.a.useEffect;function v(t,e){var r=i.a.useRef(!1);m((function(){r.current&&t(),r.current=!0}),e)}function w(t,e){var r=g(t[e]);return t[e]=void 0,r}function b(t,e,r){return void 0===r&&(r={}),function(n,s){void 0===s&&(s={});var a="string"==typeof n?e[n]:n;if(void 0===a)throw new Error("Renderer Error");return function(t,e){return r=t,function(t){return"function"==typeof t&&!(!(e=Object.getPrototypeOf(t)).prototype||!e.prototype.isReactComponent);var e}(r)||function(t){return"function"==typeof t}(r)||function(t){return"object"==typeof t&&"symbol"==typeof t.$$typeof&&["react.memo","react.forward_ref"].includes(t.$$typeof.description)}(r)?i.a.createElement(t,e):t;var r}(a,o({},t,{column:e},r,{},s))}}function x(t,e,r,n,s){var a=t=o({},u,{},e,{},t),c=a.id,l=a.accessor,p=a.Header;if("string"==typeof l){c=c||l;var h=l.split(".");l=function(t){return function(t,e,r){if(!e)return t;var n,i="function"==typeof e?e:JSON.stringify(e),o=C.get(i)||function(){var t=function(t){return function t(e,r){void 0===r&&(r=[]);if(Array.isArray(e))for(var n=0;n<e.length;n+=1)t(e[n],r);else r.push(e);return r}(t).map((function(t){return String(t).replace(".","_")})).join(".").replace(A,".").replace(D,"").split(".")}(e);return C.set(i,t),t}();try{n=o.reduce((function(t,e){return t[e]}),t)}catch(t){}return void 0!==n?n:r}(t,h)}}if(!c&&"string"==typeof p&&p&&(c=p),!c&&t.columns)throw console.error(t),new Error('A column ID (or unique "Header" value) is required!');if(!c)throw console.error(t),new Error("A column ID (or string accessor) is required!");return t=o({Header:function(){return i.a.createElement(i.a.Fragment,null," ")},Footer:function(){return i.a.createElement(i.a.Fragment,null," ")}},t,{id:c,accessor:l,parent:r,depth:n,index:s})}function _(t,e,r,n){return void 0===n&&(n=0),t.map((function(t,i){return(t=x(t,e,r,n,i)).columns&&(t.columns=_(t.columns,e,t,n+1)),t}))}function q(t,e){var r=[];return function t(n,i){var s={headers:[]},a=[],u=n.some((function(t){return t.parent}));n.forEach((function(t){var r=!a.length,n=[].concat(a).reverse()[0];if(t.parent){var i=a.filter((function(e){return e.originalId===t.parent.id}));(r||n.originalId!==t.parent.id)&&a.push(o({},t.parent,{originalId:t.parent.id,id:[t.parent.id,i.length].join("_")}))}else if(u){var c=[t.id,"placeholder"].join("_"),l=a.filter((function(t){return t.originalId===c})),p=x({originalId:c,id:[t.id,"placeholder",l.length].join("_"),placeholderOf:t},e);(r||n.originalId!==p.originalId)&&a.push(p)}(t.parent||u)&&((n=[].concat(a).reverse()[0]).headers=n.headers||[],n.headers.includes(t)||n.headers.push(t)),t.totalHeaderCount=t.headers?t.headers.reduce((function(t,e){return t+e.totalHeaderCount}),0):1,s.headers.push(t)})),r.push(s),a.length&&t(a)}(t),r.reverse()}var C=new Map;function j(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r];for(var n=0;n<e.length;n+=1)if(void 0!==e[n])return e[n]}function P(t){if("function"==typeof t)return t}function O(t,e){var r=[];return function t(n){n.forEach((function(n){n[e]?t(n[e]):r.push(n)}))}(t),r}function R(t,e){var r=e.manualExpandedKey,n=e.expanded,i=e.expandSubRows,o=void 0===i||i,s=[];return t.forEach((function t(e){e.isExpanded=e.original&&e.original[r]||n[e.id],e.canExpand=e.subRows&&!!e.subRows.length,s.push(e),o&&e.subRows&&e.subRows.length&&e.isExpanded&&e.subRows.forEach(t)})),s}var A=/\[/g,D=/\]/g;var S=function(t){return t.filter((function(t){return t.column.isVisible}))},E=function(t,e){var r=e.column;return o({key:"header_"+r.id,colSpan:r.totalVisibleHeaderCount},t)},T=function(t,e){var r=e.column;return o({key:"footer_"+r.id,colSpan:r.totalVisibleHeaderCount},t)},N=function(t,e){return o({key:"headerGroup_"+e.index},t)},B=function(t,e){return o({key:"footerGroup_"+e.index},t)},I=function(t,e){return o({key:"row_"+e.row.id},t)},F=function(t,e){var r=e.cell;return o({},t,{key:"cell_"+r.row.id+"_"+r.column.id})};function k(){return{useOptions:[],stateReducers:[],useControlledState:[],columns:[],columnsDeps:[],flatColumns:[],flatColumnsDeps:[],headerGroups:[],headerGroupsDeps:[],useInstanceBeforeDimensions:[],useInstance:[],useRows:[],cells:[S],prepareRow:[],getTableProps:[],getTableBodyProps:[],getHeaderGroupProps:[N],getFooterGroupProps:[B],getHeaderProps:[E],getFooterProps:[T],getRowProps:[I],getCellProps:[F],useFinalInstance:[]}}a.resetHiddenColumns="resetHiddenColumns",a.toggleHideColumn="toggleHideColumn",a.setHiddenColumns="setHiddenColumns",a.toggleHideAllColumns="toggleHideAllColumns";var L=function(t){t.getToggleHiddenProps=[V],t.getToggleHideAllColumnsProps=[M],t.stateReducers.push(U),t.useInstanceBeforeDimensions.push(H),t.headerGroupsDeps.push((function(t,e){var r=e.instance;return[].concat(t,[r.state.hiddenColumns])})),t.useInstance.push($)};L.pluginName="useColumnVisibility";var V=function(t,e){var r=e.column;return[t,{onChange:function(t){r.toggleHidden(!t.target.checked)},style:{cursor:"pointer"},checked:r.isVisible,title:"Toggle Column Visible"}]},M=function(t,e){var r=e.instance;return[t,{onChange:function(t){r.toggleHideAllColumns(!t.target.checked)},style:{cursor:"pointer"},checked:!r.allColumnsHidden&&!r.state.hiddenColumns.length,title:"Toggle All Columns Hidden",indeterminate:!r.allColumnsHidden&&r.state.hiddenColumns.length}]};function U(t,e,r,n){if(e.type===a.init)return o({hiddenColumns:[]},t);if(e.type===a.resetHiddenColumns)return o({},t,{hiddenColumns:n.initialState.hiddenColumns||[]});if(e.type===a.toggleHideColumn){var i=(void 0!==e.value?e.value:!t.hiddenColumns.includes(e.columnId))?[].concat(t.hiddenColumns,[e.columnId]):t.hiddenColumns.filter((function(t){return t!==e.columnId}));return o({},t,{hiddenColumns:i})}return e.type===a.setHiddenColumns?o({},t,{hiddenColumns:y(e.value,t.hiddenColumns)}):e.type===a.toggleHideAllColumns?o({},t,{hiddenColumns:(void 0!==e.value?e.value:!t.hiddenColumns.length)?n.flatColumns.map((function(t){return t.id})):[]}):void 0}function H(t){var e=t.headers,r=t.state.hiddenColumns;i.a.useRef(!1).current;var n=0;e.forEach((function(t){return n+=function t(e,n){e.isVisible=n&&!r.includes(e.id);var i=0;return e.headers&&e.headers.length?e.headers.forEach((function(r){return i+=t(r,e.isVisible)})):i=e.isVisible?1:0,e.totalVisibleHeaderCount=i,i}(t,!0)}))}function $(t){var e=t.flatHeaders,r=t.dispatch,n=t.flatColumns,o=t.state.hiddenColumns,s=g(t),u=n.length===o.length,c=i.a.useCallback((function(t,e){return r({type:a.toggleHideColumn,columnId:t,value:e})}),[r]),l=i.a.useCallback((function(t){return r({type:a.setHiddenColumns,value:t})}),[r]),h=i.a.useCallback((function(t){return r({type:a.toggleHideAllColumns,value:t})}),[r]),d=w(s().hooks,"getToggleHideAllColumnsProps"),f=p(d(),{instance:s()}),y=w(s().hooks,"getToggleHiddenProps");e.forEach((function(t){t.toggleHidden=function(e){r({type:a.toggleHideColumn,columnId:t.id,value:e})},t.getToggleHiddenProps=p(y(),{instance:s(),column:t})})),Object.assign(t,{allColumnsHidden:u,toggleHideColumn:c,setHiddenColumns:l,toggleHideAllColumns:h,getToggleHideAllColumnsProps:f})}var W={},z={},G=function(t,e,r){return t},Q=function(t,e){return t.subRows||[]},J=function(t,e,r){return""+(r?[r.id,e].join("."):e)},Y=function(t){return t};function X(t){var e=t.initialState,r=void 0===e?W:e,n=t.defaultColumn,i=void 0===n?z:n,a=t.getSubRows,u=void 0===a?Q:a,c=t.getRowId,l=void 0===c?J:c,p=t.stateReducer,h=void 0===p?G:p,d=t.useControlledState,f=void 0===d?Y:d;return o({},s(t,["initialState","defaultColumn","getSubRows","getRowId","stateReducer","useControlledState"]),{initialState:r,defaultColumn:i,getSubRows:u,getRowId:l,stateReducer:h,useControlledState:f})}var K=function(t){for(var e=arguments.length,r=new Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];t=X(t),r=[L].concat(r);var s=i.a.useRef({}),u=g(s.current);Object.assign(u(),o({},t,{plugins:r,hooks:k()})),r.filter(Boolean).forEach((function(t){t(u().hooks)}));var c=w(u().hooks,"useOptions");Object.assign(u(),h(c(),X(t)));var l=u(),f=l.data,y=l.columns,m=l.initialState,v=l.defaultColumn,x=l.getSubRows,C=l.getRowId,j=l.stateReducer,P=l.useControlledState,R=w(u().hooks,"stateReducers"),A=g(j),D=i.a.useCallback((function(t,e){if(!e.type)throw console.info({action:e}),new Error("Unknown Action 👆");return[].concat(R(),Array.isArray(A())?A():[A()]).reduce((function(r,n){return n(r,e,t,u())||r}),t)}),[R,A,u]),S=i.a.useReducer(D,void 0,(function(){return D(m,{type:a.init})})),E=S[0],T=S[1],N=w(u().hooks,"useControlledState"),B=h([].concat(N(),[P]),E,{instance:u()});Object.assign(u(),{state:B,dispatch:T});var I=w(u().hooks,"columns"),F=w(u().hooks,"columnsDeps"),V=i.a.useMemo((function(){return _(h(I(),y,{instance:u()}),v)}),[v,I,u,y].concat(h(F(),[],{instance:u()})));u().columns=V;var M=i.a.useMemo((function(){return O(V,"columns")}),[V]);u().flatColumns=M;var U=i.a.useMemo((function(){var t=[];return[f.map((function(e,r){return function e(r,n,i,o){void 0===i&&(i=0);var s=r,a={id:C(r,n,o),original:s,index:n,depth:i,cells:[{}]};t.push(a);var u=x(r,n);u&&(a.subRows=u.map((function(t,r){return e(t,r,i+1,a)})));var c=function(){throw new Error("React-Table: You have not called prepareRow(row) one or more rows you are attempting to render.")};return a.cells.map=c,a.cells.filter=c,a.cells.forEach=c,a.cells[0].getCellProps=c,a.values={},M.forEach((function(t){var e=t.id,o=t.accessor;a.values[e]=o?o(r,n,{subRows:u,depth:i,data:f}):void 0})),a}(e,r)})),t]}),[f,M,C,x]),H=U[0],$=U[1];u().rows=H,u().flatRows=$;var W=w(u().hooks,"flatColumns"),z=w(u().hooks,"flatColumnsDeps");M=i.a.useMemo((function(){return h(W(),M,{instance:u()})}),[M,W,u].concat(h(z(),[],{instance:u()}))),u().flatColumns=M;var G=w(u().hooks,"headerGroups"),Q=w(u().hooks,"headerGroupsDeps"),J=i.a.useMemo((function(){return h(G(),q(M,v),u())}),[v,M,G,u].concat(h(Q(),[],{instance:u()})));u().headerGroups=J;var Y=i.a.useMemo((function(){return J.length?J[0].headers:[]}),[J]);u().headers=Y,u().flatHeaders=J.reduce((function(t,e){return[].concat(t,e.headers)}),[]);var K=w(u().hooks,"useInstanceBeforeDimensions");d(K(),u());var tt=Z(Y),et=tt[0],rt=tt[1],nt=tt[2];u().totalColumnsMinWidth=et,u().totalColumnsWidth=rt,u().totalColumnsMaxWidth=nt;var it=w(u().hooks,"useInstance");d(it(),u());var ot=w(u().hooks,"getHeaderProps"),st=w(u().hooks,"getFooterProps");[].concat(u().flatHeaders,u().flatColumns).forEach((function(t){t.render=b(u(),t),t.getHeaderProps=p(ot(),{instance:u(),column:t}),t.getFooterProps=p(st(),{instance:u(),column:t})}));var at=w(u().hooks,"getHeaderGroupProps"),ut=w(u().hooks,"getFooterGroupProps");u().headerGroups=u().headerGroups.filter((function(t,e){return t.headers=t.headers.filter((function(t){return t.headers?function t(e){return e.filter((function(e){return e.headers?t(e.headers):e.isVisible})).length}(t.headers):t.isVisible})),!!t.headers.length&&(t.getHeaderGroupProps=p(at(),{instance:u(),headerGroup:t,index:e}),t.getFooterGroupProps=p(ut(),{instance:u(),headerGroup:t,index:e}),!0)})),u().footerGroups=[].concat(u().headerGroups).reverse();var ct=w(u().hooks,"useRows");u().rows=h(ct(),u().rows,{instance:u()});var lt=w(u().hooks,"prepareRow"),pt=w(u().hooks,"getRowProps"),ht=w(u().hooks,"getCellProps"),dt=w(u().hooks,"cells");u().prepareRow=i.a.useCallback((function(t){t.getRowProps=p(pt(),{instance:u(),row:t}),t.allCells=M.map((function(e){var r={column:e,row:t,value:t.values[e.id]};return r.getCellProps=p(ht(),{instance:u(),cell:r}),r.render=b(u(),e,{row:t,cell:r}),r})),t.cells=h(dt(),t.allCells,{instance:u()}),d(lt(),t,u())}),[pt,u,M,dt,lt,ht]);var ft=w(u().hooks,"getTableProps");u().getTableProps=p(ft(),{instance:u()});var yt=w(u().hooks,"getTableBodyProps");u().getTableBodyProps=p(yt(),{instance:u()});var gt=w(u().hooks,"useFinalInstance");return d(gt(),u()),u()};function Z(t,e){void 0===e&&(e=0);var r=0,n=0,i=0;return t.forEach((function(t){var o=t.headers;if(t.totalLeft=e,o&&o.length){var s=Z(o,e),a=s[0],u=s[1],c=s[2];t.totalMinWidth=a,t.totalWidth=u,t.totalMaxWidth=c}else t.totalMinWidth=t.minWidth,t.totalWidth=Math.min(Math.max(t.minWidth,t.width),t.maxWidth),t.totalMaxWidth=t.maxWidth;t.isVisible&&(e+=t.totalWidth,r+=t.totalMinWidth,n+=t.totalWidth,i+=t.totalMaxWidth)})),[r,n,i]}a.toggleExpanded="toggleExpanded",a.toggleAllExpanded="toggleAllExpanded",a.setExpanded="setExpanded",a.resetExpanded="resetExpanded";var tt=function(t,e,r){return t=t.filter((function(t){return e.some((function(e){var n=t.values[e];return String(n).toLowerCase().includes(String(r).toLowerCase())}))}))};tt.autoRemove=function(t){return!t};var et=function(t,e,r){return t.filter((function(t){return e.some((function(e){var n=t.values[e];return void 0===n||String(n).toLowerCase()===String(r).toLowerCase()}))}))};et.autoRemove=function(t){return!t};var rt=function(t,e,r){return t.filter((function(t){return e.some((function(e){var n=t.values[e];return void 0===n||String(n)===String(r)}))}))};rt.autoRemove=function(t){return!t};var nt=function(t,e,r){return t.filter((function(t){return e.some((function(e){var n=t.values[e];return r.includes(n)}))}))};nt.autoRemove=function(t){return!t||!t.length};var it=function(t,e,r){return t.filter((function(t){return e.some((function(e){var n=t.values[e];return n&&n.length&&r.every((function(t){return n.includes(t)}))}))}))};it.autoRemove=function(t){return!t||!t.length};var ot=function(t,e,r){return t.filter((function(t){return e.some((function(e){return t.values[e]===r}))}))};ot.autoRemove=function(t){return void 0===t};var st=function(t,e,r){return t.filter((function(t){return e.some((function(e){return t.values[e]==r}))}))};st.autoRemove=function(t){return null==t};var at=function(t,e,r){var n=r||[],i=n[0],o=n[1];if((i="number"==typeof i?i:-1/0)>(o="number"==typeof o?o:1/0)){var s=i;i=o,o=s}return t.filter((function(t){return e.some((function(e){var r=t.values[e];return r>=i&&r<=o}))}))};at.autoRemove=function(t){return!t||"number"!=typeof t[0]&&"number"!=typeof t[1]};a.resetFilters="resetFilters",a.setFilter="setFilter",a.setAllFilters="setAllFilters";a.resetGlobalFilter="resetGlobalFilter",a.setGlobalFilter="setGlobalFilter";a.resetGroupBy="resetGroupBy",a.toggleGroupBy="toggleGroupBy";var ut=/([0-9]+)/gm;function ct(t,e){return t===e?0:t>e?1:-1}function lt(t,e){return t.values[e]}function pt(t){return"number"==typeof t?isNaN(t)||t===1/0||t===-1/0?"":String(t):"string"==typeof t?t:""}var ht=Object.freeze({__proto__:null,alphanumeric:function(t,e,r){var n=lt(t,r),i=lt(e,r);for(n=pt(n),i=pt(i),n=n.split(ut).filter(Boolean),i=i.split(ut).filter(Boolean);n.length&&i.length;){var o=n.shift(),s=i.shift(),a=parseInt(o,10),u=parseInt(s,10),c=[a,u].sort();if(isNaN(c[0])){if(o>s)return 1;if(s>o)return-1}else{if(isNaN(c[1]))return isNaN(a)?-1:1;if(a>u)return 1;if(u>a)return-1}}return n.length-i.length},datetime:function(t,e,r){var n=lt(t,r),i=lt(e,r);return ct(n=n.getTime(),i=i.getTime())},basic:function(t,e,r){return ct(lt(t,r),lt(e,r))}});a.resetSortBy="resetSortBy",a.toggleSortBy="toggleSortBy",a.clearSortBy="clearSortBy",u.sortType="alphanumeric",u.sortDescFirst=!1;var dt=function(t){t.getSortByToggleProps=[ft],t.stateReducers.push(yt),t.useInstance.push(gt)};dt.pluginName="useSortBy";var ft=function(t,e){var r=e.instance,n=e.column,i=r.isMultiSortEvent,o=void 0===i?function(t){return t.shiftKey}:i;return[t,{onClick:n.canSort?function(t){t.persist(),n.toggleSortBy(void 0,!r.disableMultiSort&&o(t))}:void 0,style:{cursor:n.canSort?"pointer":void 0},title:n.canSort?"Toggle SortBy":void 0}]};function yt(t,e,r,n){if(e.type===a.init)return o({sortBy:[]},t);if(e.type===a.resetSortBy)return o({},t,{sortBy:n.initialState.sortBy||[]});if(e.type===a.clearSortBy)return o({},t,{sortBy:t.sortBy.filter((function(t){return t.id!==e.columnId}))});if(e.type===a.toggleSortBy){var i,s=e.columnId,u=e.desc,c=e.multi,l=n.flatColumns,p=n.disableMultiSort,h=n.disableSortRemove,d=n.disableMultiRemove,f=n.maxMultiSortColCount,y=void 0===f?Number.MAX_SAFE_INTEGER:f,g=t.sortBy,m=l.find((function(t){return t.id===s})).sortDescFirst,v=g.find((function(t){return t.id===s})),w=g.findIndex((function(t){return t.id===s})),b=null!=u,x=[];return"toggle"!==(i=!p&&c?v?"toggle":"add":w!==g.length-1?"replace":v?"toggle":"replace")||h||b||c&&d||!(v&&v.desc&&!m||!v.desc&&m)||(i="remove"),"replace"===i?x=[{id:s,desc:b?u:m}]:"add"===i?(x=[].concat(g,[{id:s,desc:b?u:m}])).splice(0,x.length-y):"toggle"===i?x=g.map((function(t){return t.id===s?o({},t,{desc:b?u:!v.desc}):t})):"remove"===i&&(x=g.filter((function(t){return t.id!==s}))),o({},t,{sortBy:x})}}function gt(t){var e=t.data,r=t.rows,n=t.flatColumns,o=t.orderByFn,s=void 0===o?c:o,u=t.sortTypes,l=t.manualSortBy,h=t.defaultCanSort,d=t.disableSortBy,y=t.flatHeaders,m=t.state.sortBy,b=t.dispatch,x=t.plugins,_=t.autoResetSortBy,q=void 0===_||_;f(x,["useFilters"],"useSortBy",[]);var C=function(t,e,r){b({type:a.toggleSortBy,columnId:t,desc:e,multi:r})},O=g(t),R=w(O().hooks,"getSortByToggleProps");y.forEach((function(t){var e=t.accessor,r=t.canSort,n=t.disableSortBy,i=t.id,o=e?j(!0!==n&&void 0,!0!==d&&void 0,!0):j(h,r,!1);t.canSort=o,t.canSort&&(t.toggleSortBy=function(e,r){return C(t.id,e,r)},t.clearSortBy=function(){b({type:a.clearSortBy,columnId:t.id})}),t.getSortByToggleProps=p(R(),{instance:O(),column:t});var s=m.find((function(t){return t.id===i}));t.isSorted=!!s,t.sortedIndex=m.findIndex((function(t){return t.id===i})),t.isSortedDesc=t.isSorted?s.desc:void 0}));var A=i.a.useMemo((function(){if(l||!m.length)return r;var t=m.filter((function(t){return n.find((function(e){return e.id===t.id}))}));return function e(r){var i=s(r,t.map((function(t){var e=n.find((function(e){return e.id===t.id}));if(!e)throw new Error("React-Table: Could not find a column with id: "+t.id+" while sorting");var r=e.sortType,i=P(r)||(u||{})[r]||ht[r];if(!i)throw new Error("React-Table: Could not find a valid sortType of '"+r+"' for column '"+t.id+"'.");return function(e,r){return i(e,r,t.id)}})),t.map((function(t){var e=n.find((function(e){return e.id===t.id}));return e&&e.sortInverted?t.desc:!t.desc})));return i.forEach((function(t){!t.subRows||t.subRows.length<=1||(t.subRows=e(t.subRows))})),i}(r)}),[l,m,r,n,s,u]),D=g(q);v((function(){D()&&b({type:a.resetSortBy})}),[l?null:e]),Object.assign(t,{preSortedRows:r,sortedRows:A,rows:A,toggleSortBy:C})}a.resetPage="resetPage",a.gotoPage="gotoPage",a.setPageSize="setPageSize";var mt=function(t){t.stateReducers.push(vt),t.useInstance.push(wt)};function vt(t,e,r,n){if(e.type===a.init)return o({pageSize:10,pageIndex:0},t);if(e.type===a.resetPage)return o({},t,{pageIndex:n.initialState.pageIndex||0});if(e.type===a.gotoPage){var i=n.pageCount,s=y(e.pageIndex,t.pageIndex);return s<0||s>i-1?t:o({},t,{pageIndex:s})}if(e.type===a.setPageSize){var u=e.pageSize,c=t.pageSize*t.pageIndex;return o({},t,{pageIndex:Math.floor(c/u),pageSize:u})}}function wt(t){var e=t.rows,r=t.autoResetPage,n=void 0===r||r,o=t.manualExpandedKey,s=void 0===o?"expanded":o,u=t.plugins,c=t.pageCount,l=t.paginateExpandedRows,p=void 0===l||l,h=t.expandSubRows,d=void 0===h||h,y=t.state,m=y.pageSize,w=y.pageIndex,b=y.expanded,x=y.filters,_=y.groupBy,q=y.sortBy,C=t.dispatch,j=t.data,P=t.manualPagination,O=t.manualFilters,A=t.manualGroupBy,D=t.manualSortBy;f(u,["useFilters","useGroupBy","useSortBy","useExpanded"],"usePagination",[]);var S=g(n);v((function(){S()&&C({type:a.resetPage})}),[C,P?null:j,P||O?null:x,P||A?null:_,P||D?null:q]);var E=P?c:Math.ceil(e.length/m),T=i.a.useMemo((function(){return E>0?[].concat(new Array(E)).map((function(t,e){return e})):[]}),[E]),N=i.a.useMemo((function(){var t;if(P)t=e;else{var r=m*w,n=r+m;t=e.slice(r,n)}return p?t:R(t,{manualExpandedKey:s,expanded:b,expandSubRows:d})}),[d,b,s,P,w,m,p,e]),B=w>0,I=-1===E||w<E-1,F=i.a.useCallback((function(t){C({type:a.gotoPage,pageIndex:t})}),[C]),k=i.a.useCallback((function(){return F((function(t){return t-1}))}),[F]),L=i.a.useCallback((function(){return F((function(t){return t+1}))}),[F]),V=i.a.useCallback((function(t){C({type:a.setPageSize,pageSize:t})}),[C]);Object.assign(t,{pageOptions:T,pageCount:E,page:N,canPreviousPage:B,canNextPage:I,gotoPage:F,previousPage:k,nextPage:L,setPageSize:V})}mt.pluginName="usePagination";a.resetSelectedRows="resetSelectedRows",a.toggleAllRowsSelected="toggleAllRowsSelected",a.toggleRowSelected="toggleRowSelected";a.setRowState="setRowState",a.resetRowState="resetRowState";a.resetColumnOrder="resetColumnOrder",a.setColumnOrder="setColumnOrder";u.canResize=!0,a.columnStartResizing="columnStartResizing",a.columnResizing="columnResizing",a.columnDoneResizing="columnDoneResizing";var bt={position:"absolute",top:0},xt=function(t){t.getTableBodyProps.push(_t),t.getRowProps.push(_t),t.getHeaderGroupProps.push(_t),t.useInstance.push(qt),t.getHeaderProps.push((function(t,e){var r=e.column;return[t,{style:o({},bt,{left:r.totalLeft+"px",width:r.totalWidth+"px"})}]})),t.getCellProps.push((function(t,e){var r=e.cell;return[t,{style:o({},bt,{left:r.column.totalLeft+"px",width:r.column.totalWidth+"px"})}]}))};xt.pluginName="useAbsoluteLayout";var _t=function(t,e){return[t,{style:{position:"relative",width:e.instance.totalColumnsWidth+"px"}}]};function qt(t){f(t.plugins,[],xt.pluginName,["useResizeColumns"])}function Ct(){return(Ct=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t}).apply(this,arguments)}function jt(t,e){if(null==t)return{};var r,n,i={},o=Object.keys(t);for(n=0;n<o.length;n++)r=o[n],e.indexOf(r)>=0||(i[r]=t[r]);return i}var Pt,Ot=r(1),Rt=r.n(Ot),At=r(4),Dt=r.n(At);function St(t,e){return void 0===t&&(t=""),void 0===e&&(e=Pt),e?t.split(" ").map((function(t){return e[t]||t})).join(" "):t}var Et="object"==typeof window&&window.Element||function(){};Rt.a.oneOfType([Rt.a.string,Rt.a.func,function(t,e,r){if(!(t[e]instanceof Et))return new Error("Invalid prop `"+e+"` supplied to `"+r+"`. Expected prop to be an instance of Element. Validation failed.")},Rt.a.shape({current:Rt.a.any})]);var Tt=Rt.a.oneOfType([Rt.a.func,Rt.a.string,Rt.a.shape({$$typeof:Rt.a.symbol,render:Rt.a.func}),Rt.a.arrayOf(Rt.a.oneOfType([Rt.a.func,Rt.a.string,Rt.a.shape({$$typeof:Rt.a.symbol,render:Rt.a.func})]))]);"undefined"==typeof window||!window.document||window.document.createElement;function Nt(t){var e=typeof t;return null!=t&&("object"===e||"function"===e)}var Bt={className:Rt.a.string,cssModule:Rt.a.object,size:Rt.a.string,bordered:Rt.a.bool,borderless:Rt.a.bool,striped:Rt.a.bool,dark:Rt.a.bool,hover:Rt.a.bool,responsive:Rt.a.oneOfType([Rt.a.bool,Rt.a.string]),tag:Tt,responsiveTag:Tt,innerRef:Rt.a.oneOfType([Rt.a.func,Rt.a.string,Rt.a.object])},It=function(t){var e=t.className,r=t.cssModule,n=t.size,o=t.bordered,s=t.borderless,a=t.striped,u=t.dark,c=t.hover,l=t.responsive,p=t.tag,h=t.responsiveTag,d=t.innerRef,f=jt(t,["className","cssModule","size","bordered","borderless","striped","dark","hover","responsive","tag","responsiveTag","innerRef"]),y=St(Dt()(e,"table",!!n&&"table-"+n,!!o&&"table-bordered",!!s&&"table-borderless",!!a&&"table-striped",!!u&&"table-dark",!!c&&"table-hover"),r),g=i.a.createElement(p,Ct({},f,{ref:d,className:y}));if(l){var m=St(!0===l?"table-responsive":"table-responsive-"+l,r);return i.a.createElement(h,{className:m},g)}return g};It.propTypes=Bt,It.defaultProps={tag:"table",responsiveTag:"div"};var Ft=It,kt=Rt.a.oneOfType([Rt.a.number,Rt.a.string]),Lt={tag:Tt,noGutters:Rt.a.bool,className:Rt.a.string,cssModule:Rt.a.object,form:Rt.a.bool,xs:kt,sm:kt,md:kt,lg:kt,xl:kt},Vt={tag:"div",widths:["xs","sm","md","lg","xl"]},Mt=function(t){var e=t.className,r=t.cssModule,n=t.noGutters,o=t.tag,s=t.form,a=t.widths,u=jt(t,["className","cssModule","noGutters","tag","form","widths"]),c=[];a.forEach((function(e,r){var n=t[e];if(delete u[e],n){var i=!r;c.push(i?"row-cols-"+n:"row-cols-"+e+"-"+n)}}));var l=St(Dt()(e,n?"no-gutters":null,s?"form-row":"row",c),r);return i.a.createElement(o,Ct({},u,{className:l}))};Mt.propTypes=Lt,Mt.defaultProps=Vt;var Ut=Mt,Ht=Rt.a.oneOfType([Rt.a.number,Rt.a.string]),$t=Rt.a.oneOfType([Rt.a.bool,Rt.a.number,Rt.a.string,Rt.a.shape({size:Rt.a.oneOfType([Rt.a.bool,Rt.a.number,Rt.a.string]),order:Ht,offset:Ht})]),Wt={tag:Tt,xs:$t,sm:$t,md:$t,lg:$t,xl:$t,className:Rt.a.string,cssModule:Rt.a.object,widths:Rt.a.array},zt={tag:"div",widths:["xs","sm","md","lg","xl"]},Gt=function(t,e,r){return!0===r||""===r?t?"col":"col-"+e:"auto"===r?t?"col-auto":"col-"+e+"-auto":t?"col-"+r:"col-"+e+"-"+r},Qt=function(t){var e=t.className,r=t.cssModule,n=t.widths,o=t.tag,s=jt(t,["className","cssModule","widths","tag"]),a=[];n.forEach((function(e,n){var i=t[e];if(delete s[e],i||""===i){var o=!n;if(Nt(i)){var u,c=o?"-":"-"+e+"-",l=Gt(o,e,i.size);a.push(St(Dt()(((u={})[l]=i.size||""===i.size,u["order"+c+i.order]=i.order||0===i.order,u["offset"+c+i.offset]=i.offset||0===i.offset,u)),r))}else{var p=Gt(o,e,i);a.push(p)}}})),a.length||a.push("col");var u=St(Dt()(e,a),r);return i.a.createElement(o,Ct({},s,{className:u}))};Qt.propTypes=Wt,Qt.defaultProps=zt;var Jt=Qt,Yt={children:Rt.a.node,className:Rt.a.string,listClassName:Rt.a.string,cssModule:Rt.a.object,size:Rt.a.string,tag:Tt,listTag:Tt,"aria-label":Rt.a.string},Xt=function(t){var e,r=t.className,n=t.listClassName,o=t.cssModule,s=t.size,a=t.tag,u=t.listTag,c=t["aria-label"],l=jt(t,["className","listClassName","cssModule","size","tag","listTag","aria-label"]),p=St(Dt()(r),o),h=St(Dt()(n,"pagination",((e={})["pagination-"+s]=!!s,e)),o);return i.a.createElement(a,{className:p,"aria-label":c},i.a.createElement(u,Ct({},l,{className:h})))};Xt.propTypes=Yt,Xt.defaultProps={tag:"nav",listTag:"ul","aria-label":"pagination"};var Kt=Xt,Zt={active:Rt.a.bool,children:Rt.a.node,className:Rt.a.string,cssModule:Rt.a.object,disabled:Rt.a.bool,tag:Tt},te=function(t){var e=t.active,r=t.className,n=t.cssModule,o=t.disabled,s=t.tag,a=jt(t,["active","className","cssModule","disabled","tag"]),u=St(Dt()(r,"page-item",{active:e,disabled:o}),n);return i.a.createElement(s,Ct({},a,{className:u}))};te.propTypes=Zt,te.defaultProps={tag:"li"};var ee=te,re={"aria-label":Rt.a.string,children:Rt.a.node,className:Rt.a.string,cssModule:Rt.a.object,next:Rt.a.bool,previous:Rt.a.bool,first:Rt.a.bool,last:Rt.a.bool,tag:Tt},ne=function(t){var e,r=t.className,n=t.cssModule,o=t.next,s=t.previous,a=t.first,u=t.last,c=t.tag,l=jt(t,["className","cssModule","next","previous","first","last","tag"]),p=St(Dt()(r,"page-link"),n);s?e="Previous":o?e="Next":a?e="First":u&&(e="Last");var h,d=t["aria-label"]||e;s?h="‹":o?h="›":a?h="«":u&&(h="»");var f=t.children;return f&&Array.isArray(f)&&0===f.length&&(f=null),l.href||"a"!==c||(c="button"),(s||o||a||u)&&(f=[i.a.createElement("span",{"aria-hidden":"true",key:"caret"},f||h),i.a.createElement("span",{className:"sr-only",key:"sr"},d)]),i.a.createElement(c,Ct({},l,{className:p,"aria-label":d}),f)};ne.propTypes=re,ne.defaultProps={tag:"a"};var ie=ne,oe=r(5),se=r.n(oe);function ae(){return(ae=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t}).apply(this,arguments)}var ue=function(t){var e=t.bindings,r=t.view,o=t.query,s=t.serverside;s=s||!1;var a=Object(n.useMemo)((function(){return function(){r=r||{};var t=se.a.View.table();r.rules&&t.loadJSON(r.table,r.rules);var n=new se.a.WOQLResult({bindings:e}),i=new se.a.WOQLTable(!1,t);i.setResult(n,o);for(var s=i.getColumnsToRender(),a=[],u=0;u<s.length;u++){i.getColumnHeaderContents(s[u]).innerHTML;a.push({id:s[u],accessor:s[u],Header:s[u],selector:s[u],canSort:!0})}return a}()}),[]),u=Object(n.useMemo)((function(){return function(){r=r||{};var t=se.a.View.table();r.rules&&t.loadJSON(r.table,r.rules);var n=new se.a.WOQLResult({bindings:e}),i=new se.a.WOQLTable(!1,t);i.setResult(n,o);var s=[],a=!1;for(;a=i.next();){var u={};for(var c in a)u[c]=void 0!==a[c]["@value"]?a[c]["@value"]:a[c];s.push(u)}return s}()}),[]);if(u&&a){var c=K({columns:a,data:u,initialState:{pageIndex:0},manualPagination:s},dt,mt),l=c.getTableProps,p=c.getTableBodyProps,h=c.headerGroups,d=c.prepareRow,f=c.page,y=c.canPreviousPage,g=c.canNextPage,m=(c.pageOptions,c.pageCount),v=(c.gotoPage,c.nextPage),w=c.previousPage,b=c.setPageSize,x=c.state,_=x.pageIndex,q=x.pageSize;return i.a.createElement("span",null,i.a.createElement(Ft,ae({},l(),{hover:!0}),i.a.createElement("thead",null,h.map((function(t){return i.a.createElement("tr",t.getHeaderGroupProps(),t.headers.map((function(t){return i.a.createElement("th",t.getHeaderProps(t.getSortByToggleProps()),t.render("Header"),i.a.createElement("span",null,t.isSorted?t.isSortedDesc?" 🔽":" 🔼":""))})))}))),i.a.createElement("tbody",p(),f.map((function(t,e){return d(t),i.a.createElement("tr",t.getRowProps(),t.cells.map((function(t){return i.a.createElement("td",t.getCellProps(),t.render("Cell"))})))})))),i.a.createElement(Ut,{md:12},i.a.createElement(Jt,{md:6},i.a.createElement(Kt,{className:"pagination"},i.a.createElement(ee,null,i.a.createElement(ie,{previous:!0,href:"#",onClick:function(){return w()},disabled:!y})),i.a.createElement(ee,null,i.a.createElement(ie,{next:!0,href:"#",onClick:function(){return v()},disabled:!g})))),i.a.createElement(Jt,{md:6,className:"justify-content-end"},i.a.createElement("span",null,"Page"," ",i.a.createElement("strong",null,_+1," of ",m)," "),i.a.createElement("select",{value:q,onChange:function(t){b(Number(t.target.value))}},[10,20,30,40,50].map((function(t){return i.a.createElement("option",{key:t,value:t},"Show ",t)}))))))}};r.d(e,"WOQLTable",(function(){return ue}))}]);